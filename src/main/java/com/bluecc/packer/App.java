...
public class App {
    ...
    static class RoutinesImpl extends RoutinesGrpc.RoutinesImplBase {
        ...
        public void getConfig(ConfigItem request, StreamObserver<ValueObject> responseObserver) {
            super.getConfig(request, responseObserver);
        }

        @Override
        public void checkValue(ValueObject request, StreamObserver<ValueObject> responseObserver) {
            ValueObject reply=request;
            responseObserver.onNext(reply);
            responseObserver.onCompleted();
        }
    }
